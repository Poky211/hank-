function onCreate()
	...
	for i = 0, getProperty('unspawnNotes.length')-1 do
		--Check if the note is a reflect bullets
		if getPropertyFromGroup('unspawnNotes', i, 'noteType') == 'reflect bullets' then
			setPropertyFromGroup('unspawnNotes', i, 'texture', 'customnotes/rbullet_notes'); --Change texture
...
function goodNoteHit(id, noteData, noteType, isSustainNote)
	if noteType == 'reflect bullets' then
		playSound('hankshoot', 0.8)
		characterPlayAnim('boyfriend', dodgeAnimations[noteData+1], true);
		setProperty('boyfriend.specialAnim', true);		
		characterPlayAnim('gf', 'block', true);
